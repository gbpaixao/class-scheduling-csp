...
public class Main {
	...
	public static void drawTimetable(Assignment<Variable, String> solution) {
		...
		timetable.append("   Horários    | Segunda |  Terça  |  Quarta  |  Quinta  |  Sexta  |  Sábado  \n");
