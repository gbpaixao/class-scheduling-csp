...
public class DrawTimetable {
	...
	public void draw(Assignment<Variable, String> solution) {
		...
		String H2M1 = String.format("%1$-12s", "---");
		String H3M1 = String.format("%1$-12s", "---");
		String H4M1 = String.format("%1$-12s", "---");
		String H5M1 = String.format("%1$-12s", "---");
		String H6M1 = String.format("%1$-12s", "---");
		String H2M2 = String.format("%1$-12s", "---");
		String H3M2 = String.format("%1$-12s", "---");
		String H4M2 = String.format("%1$-12s", "---");
		String H5M2 = String.format("%1$-12s", "---");
		String H6M2 = String.format("%1$-12s", "---");
		String H2M3 = String.format("%1$-12s", "---");
		String H3M3 = String.format("%1$-12s", "---");
		String H4M3 = String.format("%1$-12s", "---");
		String H5M3 = String.format("%1$-12s", "---");
		String H6M3 = String.format("%1$-12s", "---");
		String H2M4 = String.format("%1$-12s", "---");
		String H3M4 = String.format("%1$-12s", "---");
		String H4M4 = String.format("%1$-12s", "---");
		String H5M4 = String.format("%1$-12s", "---");
		String H6M4 = String.format("%1$-12s", "---");
		String H2M5 = String.format("%1$-12s", "---");
		String H3M5 = String.format("%1$-12s", "---");
		String H4M5 = String.format("%1$-12s", "---");
		String H5M5 = String.format("%1$-12s", "---");
		String H6M5 = String.format("%1$-12s", "---");
		String H2M6 = String.format("%1$-12s", "---");
		String H3M6 = String.format("%1$-12s", "---");
		String H4M6 = String.format("%1$-12s", "---");
		String H5M6 = String.format("%1$-12s", "---");
		String H6M6 = String.format("%1$-12s", "---");
		String H2T1 = String.format("%1$-12s", "---");
		String H3T1 = String.format("%1$-12s", "---");
		String H4T1 = String.format("%1$-12s", "---");
		String H5T1 = String.format("%1$-12s", "---");
		String H6T1 = String.format("%1$-12s", "---");
		String H2T2 = String.format("%1$-12s", "---");
		String H3T2 = String.format("%1$-12s", "---");
		String H4T2 = String.format("%1$-12s", "---");
		String H5T2 = String.format("%1$-12s", "---");
		String H6T2 = String.format("%1$-12s", "---");
		String H2T3 = String.format("%1$-12s", "---");
		String H3T3 = String.format("%1$-12s", "---");
		String H4T3 = String.format("%1$-12s", "---");
		String H5T3 = String.format("%1$-12s", "---");
		String H6T3 = String.format("%1$-12s", "---");
		String H2T4 = String.format("%1$-12s", "---");
		String H3T4 = String.format("%1$-12s", "---");
		String H4T4 = String.format("%1$-12s", "---");
		String H5T4 = String.format("%1$-12s", "---");
		String H6T4 = String.format("%1$-12s", "---");
		String H2T5 = String.format("%1$-12s", "---");
		String H3T5 = String.format("%1$-12s", "---");
		String H4T5 = String.format("%1$-12s", "---");
		String H5T5 = String.format("%1$-12s", "---");
		String H6T5 = String.format("%1$-12s", "---");
		String H2T6 = String.format("%1$-12s", "---");
		String H3T6 = String.format("%1$-12s", "---");
		String H4T6 = String.format("%1$-12s", "---");
		String H5T6 = String.format("%1$-12s", "---");
		String H6T6 = String.format("%1$-12s", "---");
		String H2N1 = String.format("%1$-12s", "---");
		String H2N2 = String.format("%1$-12s", "---");
		String H2N3 = String.format("%1$-12s", "---");
		String H2N4 = String.format("%1$-12s", "---");
		String H3N1 = String.format("%1$-12s", "---");
		String H3N2 = String.format("%1$-12s", "---");
		String H3N3 = String.format("%1$-12s", "---");
		String H3N4 = String.format("%1$-12s", "---");
		String H4N1 = String.format("%1$-12s", "---");
		String H4N2 = String.format("%1$-12s", "---");
		String H4N3 = String.format("%1$-12s", "---");
		String H4N4 = String.format("%1$-12s", "---");
		String H5N1 = String.format("%1$-12s", "---");
		String H5N2 = String.format("%1$-12s", "---");
		String H5N3 = String.format("%1$-12s", "---");
		String H5N4 = String.format("%1$-12s", "---");
		String H6N1 = String.format("%1$-12s", "---");
		String H6N2 = String.format("%1$-12s", "---");
		String H6N3 = String.format("%1$-12s", "---");
		String H6N4 = String.format("%1$-12s", "---");
		...
		for (Variable variable : variables) {
			...
			int actualLength = varValue.length();
			varValue = String.format("%1$-12s", varValue);
